<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fileupload.aspx.cs" Inherits="GrowTogetherClient.Fileupload" %>
                    ...
                    <asp:BoundField DataField="Text" HeaderText="File Name"/>    
                     <asp:TemplateField>    
                        <ItemTemplate>    
                            ...
                            <asp:LinkButton ID="DownloadLink" runat="server" Text="Download" OnClick="DownloadData" CommandArgument='<%# Eval("Value") %>'><img src="Images/download.jpeg" height=30 width=30/></asp:LinkButton>    
                        </ItemTemplate>    
